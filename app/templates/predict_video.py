...
best_model_path = os.path.join(base_dir, 'tmp_checkpoint', 'best_model.h5')
...
def predict_video(video_path):
    tmp_path = os.path.join(base_dir, 'testing_video', get_filename_only(video_path))
    ...
    while cap.isOpened():
        ...
        if frame_id % int(frame_rate) == 0:
            ...
            new_filename = os.path.join(tmp_path, f'{get_filename_only(video_path)}-{count:03d}.png')
            count += 1
